...
using BarberBoss.Application.UseCases.Expenses.Reports.Pdf.Colors;
using BarberBoss.Application.UseCases.Expenses.Reports.Pdf.Fonts;
...
namespace BarberBoss.Application.UseCases.Expenses.Reports.Pdf;
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach (var expense in expenses)
        {
            ...
            if (string.IsNullOrWhiteSpace(expense.Description) == false)
            {
                ...
                var desc = expense.Description ?? string.Empty;
                var paragraph = descriptionRow.Cells[0].AddParagraph(desc);
                paragraph.Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Size = 10, Color = ColorsHelper.BLACK };
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Leonardo Albano";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        row.Cells[1].AddParagraph("Salve, Leonardo Albano");
